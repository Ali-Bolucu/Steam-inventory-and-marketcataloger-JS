    ...
    checkPageButton.addEventListener(
      ...
      function () {
        ...
        function fect_market() {
          fetch(`https://steamcommunity.com/market/myhistory/render/?query=&start=${curr_pos}&count=500`)
            .then(function (u) {
              return u.json();
            })
            .then(function (data) {
              ...
              curr_pos += 500;
              document.getElementById("deneme").innerHTML += "WAIT! : " + curr_pos;

              if (market_h[0].game_name > curr_pos) {
                fect_market();
              } else {
                document.getElementById("deneme").innerHTML += "DONE! , Total number of transection:" + market_h[0].game_name;
